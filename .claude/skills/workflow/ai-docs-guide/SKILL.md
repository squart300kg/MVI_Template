...
2. `./scripts/sync-harness-docs.sh copy`를 실행합니다.
3. `./scripts/verify-harness-consistency.sh`로 mirror 정합성을 확인합니다.
4. Gradle task가 필요한 변경이면 `./gradlew verifyHarnessConsistency`도 실행합니다.

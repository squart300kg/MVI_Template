---
name: architecture-baseline-guide
description: MVI Template에서 Android 기능을 추가하거나 수정할 때 Clean Architecture, MVI, 모듈 경계를 확인하는 스킬.
---

# architecture-baseline-guide

## 목적

빠르게 구현하더라도 현재 Clean Architecture + MVI 골격과 module dependency 방향을 유지합니다.

## 사용 시점

- 새 feature, use case, repository, API를 추가할 때
- 기존 feature의 화면, ViewModel, domain/data 흐름을 수정할 때
- 구현 전 어느 모듈에 코드를 둘지 판단해야 할 때

package kr.co.architecture.network.operator
...
class ResponseBaseOperator<ENTITY, DTO>(
    ...
    override suspend fun onError(apiResponse: ApiResponse.Failure.Error<CommonResponse<ENTITY>>) {
        throw ArchitectureSampleHttpException(
    ...
    override suspend fun onException(apiResponse: ApiResponse.Failure.Exception<CommonResponse<ENTITY>>) {
